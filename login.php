...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    } catch (Throwable $e) { $err = 'Login failed: ' . $e->getMessage(); }
}
?>
...
<title>Login · CitySphere</title><link rel="stylesheet" href="assets/css/style.css"></head>
<body class="auth-page">
<div class="auth-wrap">
  <div class="auth-brand"><span style="font-size:2.5rem">🏙</span>
    <h1>Welcome back</h1><p>Sign in to your CitySphere account</p></div>
  <div class="card">
